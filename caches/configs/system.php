...
'cookie_pre' => 'LioSs_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
'cookie_ttl' => 0, //Cookie 生命周期，0 表示随浏览器进程
//模板相关配置
'tpl_root' => 'templates/', //模板保存物理路径
'tpl_name' => 'gzhx', //当前模板方案目录
...
'upload_url' => 'http://localhost/gzhx.com/uploadfile/', //附件路径
...
'app_path' => 'http://localhost/gzhx.com/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'nuTy24CT9kxY60L85g0p', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost/gzhx.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'MTIFSvTG5msgrOuRw8APBdHwKH5GpQqN', //加密密钥
